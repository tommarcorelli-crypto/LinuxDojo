...
| Mode | Description |
|---|---|
| 📖 **Apprendre** | 9 scénarios réalistes, 54 missions : leçon → exercice → explication. Quiz de fin de chapitre + révision espacée. Du premier `ls` jusqu'à la réponse à incident, l'**automatisation par scripts**, le **versioning avec Git** et l'**administration distante en SSH**. Indices à 3 paliers (nudge gratuit → syntaxe → solution) pour ne jamais rester bloqué. |
