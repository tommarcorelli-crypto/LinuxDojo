...
const UI = {
  fr: {
    ...
    "mode.learn.tag": "14 scénarios · 84 missions",
    ...
    "mode.challenge.tag": "24 défis · Combo & record",
    "mode.oncall.title": "Salle d'astreinte",
    "mode.oncall.desc": "Un incident généré au hasard, aucune leçon, aucun indice. Diagnostique et répare comme en vraie astreinte.",
    "mode.oncall.tag": "Incidents infinis · Score au temps",
    ...
    "mode.boss.tag": "7 boss · Ceinture Noire",
    ...
    "mode.kata.tag": "9 katas · Vitesse & record",
    ...
    "belt.statDate": "OBTENUE LE",
    "belt.lockedAt": "Se débloque à {xp} XP",
    "belt.shareText": "🥋 {name} vient de décrocher sa {belt} sur LinuxDojo ! linuxdojo.dev",
    ...
    "l.hero.sub": "Pas un PDF, pas une liste de commandes à réciter. Un vrai mini-shell simulé — pipes, variables, scripts — avec 84 missions scénarisées, des combats de boss, et une Ceinture Noire à décrocher.",
    ...
    "l.stats.missions": "<b>84</b> missions",
    "l.stats.boss": "<b>7</b> combats de boss",
    "l.stats.infil": "<b>15</b> niveaux d'infiltration",
    "l.stats.challenges": "<b>24</b> défis chrono",
    "l.stats.katas": "<b>9</b> katas de vitesse",
    ...
    "l.mode.learn.d": "14 scénarios réalistes, 84 missions : leçon → exercice → explication. Indices à 3 paliers pour ne jamais rester bloqué.",
    "l.mode.learn.tag": "14 scénarios · 84 missions",
    ...
    "l.mode.challenge.tag": "24 défis · Combo & record",
    ...
    "l.mode.boss.d": "7 combats épiques en plusieurs phases, jusqu'à l'examen du Sensei. Bats-le pour débloquer ton certificat.",
    "l.mode.boss.tag": "7 boss · Ceinture Noire",
    "l.mode.kata.t": "Kata",
    "l.mode.kata.d": "La mémoire musculaire du shell : des enchaînements de vraies commandes à taper au chrono. WPM & précision.",
    "l.mode.kata.tag": "9 katas · Vitesse & record",
    ...
    "l.footer.discord": "Discord",
    "l.cta.discord": "💬 Rejoindre la communauté Discord",
    ...
    "bossrush.desc": "Enchaîne les 7 boss d'affilée. 3 cœurs pour tout le parcours, pas un par combat. Chrono au meilleur temps.",
    "bossrush.locked": "🔒 Vaincs les 7 boss (au moins une fois chacun) pour débloquer le Rush.",
    "bossrush.start": "🏁 Lancer le Rush",
    "bossrush.record": "🏅 Record : {time}",
    "bossrush.noRecord": "Aucun record pour l'instant.",
    "bossrush.next": "→ Boss suivant : {n}/{total}...",
    "bossrush.complete": "🏆 RUSH TERMINÉ EN {time} !",
    "bossrush.newRecord": "✨ Nouveau record !",
    "bossrush.failed": "Le Rush s'arrête ici : boss {n}/{total}.",
    "bossrush.retry": "🏁 Retenter le Rush",
    "bossrush.achTitle": "Boss Rush terminé !",
    ...
    "profile.discord": "💬 Rejoindre le Discord",
  ...
  en: {
    ...
    "mode.learn.tag": "14 scenarios · 84 missions",
    ...
    "mode.challenge.tag": "24 challenges · Combo & record",
    "mode.oncall.title": "On-call Room",
    "mode.oncall.desc": "A randomly generated incident, no lesson, no hint. Diagnose and fix it like a real on-call shift.",
    "mode.oncall.tag": "Endless incidents · Time score",
    "mode.bandit.title": "Infiltration",
    ...
    "cert.statMissions": "MISSIONS",
    "belt.statDate": "EARNED ON",
    "belt.lockedAt": "Unlocks at {xp} XP",
    "belt.shareText": "🥋 {name} just earned their {belt} on LinuxDojo! linuxdojo.dev",
    ...
    "l.hero.sub": "Not a PDF, not a list of commands to recite. A real simulated mini-shell — pipes, variables, scripts — with 84 scripted missions, boss fights, and a Black Belt to earn.",
    ...
    "l.stats.missions": "<b>84</b> missions",
    "l.stats.boss": "<b>7</b> boss fights",
    "l.stats.infil": "<b>15</b> infiltration levels",
    "l.stats.challenges": "<b>24</b> timed challenges",
    "l.stats.katas": "<b>9</b> speed katas",
    ...
    "l.mode.learn.d": "14 realistic scenarios, 84 missions: lesson → exercise → explanation. 3-tier hints so you're never stuck.",
    "l.mode.learn.tag": "14 scenarios · 84 missions",
    ...
    "l.mode.challenge.tag": "24 challenges · Combo & record",
    "l.mode.bandit.t": "Infiltration",
    ...
    "l.mode.boss.d": "7 epic multi-phase fights, up to the Sensei's exam. Beat him to unlock your certificate.",
    "l.mode.boss.tag": "7 bosses · Black Belt",
    "l.mode.kata.t": "Kata",
    "l.mode.kata.d": "Shell muscle memory: sequences of real commands to type against the clock. WPM & accuracy.",
    "l.mode.kata.tag": "9 katas · Speed & record",
    ...
    "l.footer.discord": "Discord",
    "l.cta.discord": "💬 Join the Discord community",
    ...
    "bossrush.title": "🏆 Boss Rush",
    "bossrush.desc": "Chain all 7 bosses back to back. 3 hearts for the whole run, not per fight. Best-time chrono.",
    "bossrush.locked": "🔒 Beat all 7 bosses (at least once each) to unlock the Rush.",
    "bossrush.start": "🏁 Start the Rush",
    "bossrush.record": "🏅 Record: {time}",
    "bossrush.noRecord": "No record yet.",
    "bossrush.next": "→ Next boss: {n}/{total}...",
    "bossrush.complete": "🏆 RUSH COMPLETE IN {time}!",
    "bossrush.newRecord": "✨ New record!",
    "bossrush.failed": "The Rush stops here: boss {n}/{total}.",
    "bossrush.retry": "🏁 Retry the Rush",
    "bossrush.achTitle": "Boss Rush complete!",
    ...
    "profile.discord": "💬 Join the Discord",
